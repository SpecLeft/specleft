...
4. You have authority to complete the full workflow from issue to PR, but do not have authority to pick issues outside of the defined priority order.
5. Only create branches and raise PRs against the feature/discovery-layer branch, never directly against main. This feature branch will be used to review and merge all Discovery Layer work before it goes to main.
...
- Access to the [SpecLeft GitHub Project board](https://github.com/orgs/SpecLeft/projects/2)

---

## Step 1: Pick the Next Issue

Retrieve the top item from the SpecLeft Discovery Layer project for iteration 1. If issues in iteration 1 are complete, move to the next iteration.

Group by iteration and priority to find the current iteration's issues:

URL: https://github.com/orgs/SpecLeft/projects/2/views/1
